export default {
  requirementAnalysis: {
    ...
    requirementIds: '需求ID',
    requirementIdsPlaceholder: '多个需求ID可用逗号或换行分隔',
    caseType: '用例类型',
    caseTypePlaceholder: '如：功能测试、接口测试、性能测试',
    caseCreator: '创建人',
    caseCreatorPlaceholder: '请输入创建人',
    iteration: '归属迭代',
    iterationPlaceholder: '如：2026.06 迭代',
    ...
    stepComplete: '生成完成',
    stepPrd: 'PRD处理',
    stepPointReview: '测试点审核',
    stepCaseGeneration: '用例生成',
    stepCaseReview: '用例审核',
    ...
    statusTestPointsReady: '测试点已生成，请审核',
    statusGeneratingCases: '正在根据审核后的测试点生成测试用例...',
    statusCasesReady: '测试用例已生成，请预览审核',
    statusCompleted: '生成完成！',
    statusFailed: '生成失败',
    generateCompleteSuccess: '测试用例生成完成！',
    testPointsReady: '测试点已生成，请先审核测试点',
    testCasesReady: '测试用例已生成，请预览审核',
    ...
    saveToRecords: '保存到记录',
    testPointReviewTitle: '测试点人工审核',
    testPointReviewHint: '可在这里补充、删改或调整测试点，审核通过后才会生成测试用例。',
    casePreviewTitle: '测试用例预览审核',
    casePreviewHint: '可在导出前编辑用例内容，审核通过后才能下载 Excel。',
    pointId: '测试点ID',
    pointTitle: '测试点标题',
    caseId: '用例ID',
    caseTitle: '用例名称',
    ...
    expectedResult: '预期结果',
    saveEdits: '保存修改',
    approveAndGenerateCases: '审核通过并生成用例',
    approveCases: '审核通过',
    reviewPending: '待审核',
    reviewRevisionRequested: '已修改待确认',
    reviewApproved: '已审核',
    saveSuccessMessage: '已保存修改',
    approveFailed: '审核失败',
    testPointsApproved: '测试点审核通过，开始生成测试用例',
    testCasesApproved: '测试用例审核通过，可以导出 Excel',
    approveBeforeExport: '请先完成测试用例审核',
