export default {
  requirementAnalysis: {
    ...
    requirementIdsPlaceholder: 'Separate multiple IDs with commas or new lines',
    caseType: 'Case Type',
    caseTypePlaceholder: 'E.g. Functional, API, Performance',
    caseCreator: 'Creator',
    caseCreatorPlaceholder: 'Enter creator',
    iteration: 'Iteration',
    iterationPlaceholder: 'E.g. 2026.06 iteration',
    ...
    stepPrd: 'PRD',
    stepPointReview: 'Point Review',
    stepCaseGeneration: 'Case Generation',
    stepCaseReview: 'Case Review',
    ...
    statusTestPointsReady: 'Test points are ready for review',
    statusGeneratingCases: 'Generating test cases from approved points...',
    statusCasesReady: 'Test cases are ready for preview review',
    statusCompleted: 'Generation complete!',
    statusFailed: 'Generation failed',
    generateCompleteSuccess: 'Test case generation complete!',
    testPointsReady: 'Test points are ready. Please review them first.',
    testCasesReady: 'Test cases are ready. Please review the preview.',
    ...
    testPointReviewTitle: 'Manual Test Point Review',
    testPointReviewHint: 'Edit, add, or refine test points here. Test cases are generated only after approval.',
    casePreviewTitle: 'Test Case Preview Review',
    casePreviewHint: 'Edit generated cases before export. Excel export is enabled only after approval.',
    pointId: 'Point ID',
    ...
    approveAndGenerateCases: 'Approve and Generate Cases',
    approveCases: 'Approve Cases',
    reviewPending: 'Pending',
    reviewRevisionRequested: 'Edited',
    reviewApproved: 'Approved',
    saveSuccessMessage: 'Changes saved',
    approveFailed: 'Approval failed',
    testPointsApproved: 'Test points approved. Generating test cases.',
    testCasesApproved: 'Test cases approved. Excel export is available.',
    approveBeforeExport: 'Please approve test cases before export',
